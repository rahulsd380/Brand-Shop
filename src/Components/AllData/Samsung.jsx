...
const Samsung = () => {
    ...
    const handleDelete = (_id) => {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          fetch(`http://localhost:5000/samsungData/${_id}` , {
            method : "DELETE"
          })
          .then(res => res.json())
          .then(data => {
  ...
  <div id="slide1" className="carousel-item relative w-full">
    <div className="px-20 py-9 grid md:grid-cols-2 gap-10 items-center">
        <div>
        <h1 className="text-white font-bold text-5xl mb-7">Experience the Latest Ever Samsung Smartphones By This Era...</h1>
        ...
        <div className="flex gap-10">
            <Link to={"/signup"} className="rounded-lg focus:outline-none h-12 px-5 bg-[#a18157] text-white font-semibold hover:bg-[#E3B577] transition duration-300 flex items-center w-auto">
            Explore More
            </Link>
        ...
        <div>
            <img className="w-3/4" src="../../../../public/samsung (6).png" alt="" />
        </div>
    </div>
  ...
  <div className="px-20 py-9 grid md:grid-cols-2 gap-10 items-center">
        ...
        <div>
            <img className="w-3/4" src="../../../public/samsung (4).png" alt="" />
        </div>
    </div>
    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
  ...
  <div className="px-20 py-9 grid md:grid-cols-2 gap-10 items-center">
        ...
        <div>
            <img className="w-3/4" src="../../../public/samsung (9).png" alt="" />
        </div>
    </div>
    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
      <a href="#slide3" className="btn btn-circle">❮</a> 
      ...
      <div>
       ...
       <div className="flex justify-between items-center">
        ...
        <div className="flex gap-3 items-center">
            <p className="text-2xl text-red-600 font-bold">{card.price}</p>
            <p className="text-lg text-gray-500 line-through">{card.previousPrice}</p>
        </div>
        <div>
            <div className="flex justify-between items-center mb-3">
                ...
                <div className="tooltip" data-tip="Delete Product">
                    <button onClick={ () => handleDelete(card._id)}><FaDeleteLeft className="text-red-600 text-3xl"></FaDeleteLeft></button>
                </div>
            </div>

            <div className=" mt-4 flex justify-between gap-4">
                <Link to={`/details1/${card._id}`}  className="focus:outline-none h-12 w-auto p-3 border border-gray-400 rounded-md bg-slate-100 font-semibold hover:bg-[#e6e7f5] transition duration-300 flex items-center justify-center">
                 View details
                </Link>
