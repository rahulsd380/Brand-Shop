...
const AddXiomi = () => {
  ...
  <div id="slide1" className="carousel-item relative w-full">
    <div className="px-20 py-9 grid md:grid-cols-2 gap-10 items-center">
        ...
        <div>
            <img className="w-3/4" src="../../../../public/xiomi (6).png" alt="" />
        </div>
    </div>
  ...
  <div className="px-20 py-9 grid md:grid-cols-2 gap-10 items-center">
        ...
        <div>
            <img className="w-3/4" src="../../../../public/xiomi (2).png" alt="" />
        </div>
    </div>
    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
  ...
  <div className="px-20 py-9 grid md:grid-cols-2 gap-10 items-center">
        ...
        <div>
            <img className="w-3/4" src="../../../../public/xiomi (7).png" alt="" />
        </div>
    </div>
    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
      <a href="#slide2" className="btn btn-circle">❮</a> 
       ...
       <div className="flex justify-between items-center">
        ...
        <div>
            ...
            <div className=" mt-4 flex justify-between gap-4">
                <Link to={`/xiomiDetails/${card._id}`}  className="focus:outline-none h-12 w-auto p-3 border border-gray-400 rounded-md bg-slate-100 font-semibold hover:bg-[#e6e7f5] transition duration-300 flex items-center justify-center">
                 View details
                </Link>
            ...
            <Link to={"/addXiomi"} className="btn">Add a new product</Link>
        </div>
    );
};

export default AddXiomi;
